...
var i18n = (function () {
  ...
  var translations = {
    en: {
      ...
      proj4_title: 'Cross-Play Minecraft Server on Oracle Cloud',
      proj4_desc: 'Deployed a production Java + Bedrock cross-play Minecraft server on an Oracle Cloud Infrastructure Always Free ARM VM using Docker. Runs PaperMC with GeyserMC and Floodgate plugins, enabling seamless play between Java Edition (PC, TLauncher) and Bedrock Edition (mobile, console, Windows 10) players on the same world. Configured offline-mode authentication, iptables firewall rules, OCI security lists, Docker restart policies, and container health monitoring. Built a custom real-time monitoring dashboard: a Python service polls the server every 60 seconds via mcstatus, collects CPU, RAM, disk, and player metrics, and writes rolling JSON consumed by a vanilla JavaScript front end served through Nginx. The server and dashboard run 24/7 with real player traffic. <a href="http://144.22.198.184" target="_blank" rel="noopener noreferrer">View Live Dashboard \u2192</a>',
    ...
    pt: {
      ...
      proj4_title: 'Servidor Minecraft Cross-Play na Oracle Cloud',
      proj4_desc: 'Deploy de um servidor Minecraft Java + Bedrock cross-play em uma VM ARM Always Free da Oracle Cloud usando Docker. Roda PaperMC com plugins GeyserMC e Floodgate, permitindo jogo entre Java Edition (PC, TLauncher) e Bedrock Edition (mobile, console, Windows 10) no mesmo mundo. Configura\u00E7\u00E3o de autentica\u00E7\u00E3o offline-mode, regras de firewall iptables, security lists da OCI, pol\u00EDticas de restart do Docker e monitoramento de sa\u00FAde do container. Constru\u00ED um painel de monitoramento em tempo real: um servi\u00E7o Python consulta o servidor a cada 60 segundos via mcstatus, coleta m\u00E9tricas de CPU, RAM, disco e jogadores, e grava JSON rotativo consumido por um front end em JavaScript puro servido pelo Nginx. O servidor e o dashboard rodam 24/7 com tr\u00E1fego real de jogadores. <a href="http://144.22.198.184" target="_blank" rel="noopener noreferrer">Ver Dashboard ao Vivo \u2192</a>',
